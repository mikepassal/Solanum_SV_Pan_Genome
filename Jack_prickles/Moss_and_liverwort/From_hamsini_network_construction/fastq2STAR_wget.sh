...
input="/data/passala/git/Solanum_SV_Pan_Genome/Jack_prickles/Moss_and_liverwort/Marchantia_file_list/marchantia_accs.csv"

nCore=4        # attempted to parallel download fastq files, but ends up running into connection issues on the ftp side if you try to download too many things.
nCoreSTAR=30  
